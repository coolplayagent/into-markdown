...
| [66025096](evidence/negative/codex-clipboard-66025096-1ec7-44b4-a4cf-2e330a1884c9.png) | History is capped and hidden behind another large window. | `c36536e`; `workbench-1365x768.png`. | Full pagination; shrink the final page and confirm immediate clamping. |
...
| [50d78471](evidence/negative/codex-clipboard-50d78471-48ff-49e1-8810-e6ae56e877fa.png) | Pin/retry/delete menu is function-only evidence. | `c36536e`, `dd3c6f1`; danger/confirm/focus regression. | Menu, pin, retry, delete, Escape, Tab boundary and focus restore. |
...
| [0d440beb](evidence/negative/codex-clipboard-0d440beb-76ab-413f-adbe-3ab0f487a001.png) | Inline vendor-specific Provider form and missing pagination. | `c36536e`, `dd3c6f1`; neutral AI service dialog and bounded page regression. | Add/edit/page, delete the only final-page item, Tab boundary and focus restore. |
...
| [d7871672](evidence/negative/codex-clipboard-d7871672-5dd2-48c7-b546-45ded5266db6.png) | Broken responsive styles and raw signing fields. | `c36536e`, `dd3c6f1`; four-viewport admin matrix and shared dialog lifecycle. | Local extension dialog/details, Tab boundary and focus restore. |
