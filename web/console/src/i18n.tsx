...
const messages = {
  "zh-CN": {
    ...
    ocrResourceOmission: "部分图片超出文字识别的宽度、像素、张量或结构额度，正文、原图及其他识别结果已保留。",
  ...
  en: {
    ...
    ocrResourceOmission: "Some images exceeded recognition width, pixel, tensor, or structure limits. Native content, original images and other recognition results were preserved.",
