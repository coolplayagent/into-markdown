...
const messages = {
  "zh-CN": {
    ...
    authorizeProvider: "我授权这些上传使用已配置的 AI 服务", authorizeRemoteConversion: "允许本次转换使用所选 AI 服务", authorizeMeetingProvider: "允许本次音频使用所选 AI 服务并联网转写", authorizationNote: "仅适用于本次上传，不会保存。", authorizationRequired: "请先同意本次使用所选 AI 服务。", remoteNetworkRequired: "所选图片识别来源需要联网。请先同意本次使用。",
    ...
    audioNeedsSetupNearby: "请选择可用的转写来源。", meetingTranscript: "语音逐字稿", viewTranscript: "查看逐字稿", transcribing: "正在生成逐字稿", generateTranscript: "生成逐字稿", recentMeetings: "最近记录", noMeetingHistory: "还没有转写记录。",
  ...
  en: {
    ...
    audioNeedsSetupNearby: "Choose an available transcription source.", meetingTranscript: "Transcript", viewTranscript: "View transcript", transcribing: "Creating transcript", generateTranscript: "Create transcript", recentMeetings: "Recent", noMeetingHistory: "No transcripts yet.",
