...
const messages = {
  "zh-CN": {
    ...
    convertDocuments: "转换文档", convertDocumentsIntro: "添加文件，智能识别内容，快速得到结构清晰的 Markdown。",
    sourceFiles: "来源文件", conversionSettings: "转换设置", smartDefaults: "使用智能默认值", outputFormat: "输出格式", recognitionMode: "识别模式",
    smart: "智能", precise: "精确", separateAssets: "单独保存", embedAssets: "嵌入文档", omitAssets: "忽略资源", advancedSettings: "高级设置",
    documentParsing: "文档解析", imageOcr: "图片 OCR", audioTranscription: "音频转写", localReady: "本地就绪", automaticDetection: "自动检测", enabled: "已启用", disabled: "未启用", enableInWorkbench: "可在工作台启用", capabilities: "本地能力",
    ...
    capabilityCenter: "本地能力", capabilityCenterIntro: "查看文档转换服务是否可以正常工作。", allLocalServicesReady: "本地转换服务已就绪，可以返回工作台继续。", checkingSystemDetail: "正在确认本地转换服务与任务存储。",
  ...
  en: {
    ...
    sourceFiles: "Source files", conversionSettings: "Conversion settings", smartDefaults: "Smart defaults", outputFormat: "Output format", recognitionMode: "Recognition mode",
    smart: "Smart", precise: "Precise", separateAssets: "Save separately", embedAssets: "Embed", omitAssets: "Omit", advancedSettings: "Advanced settings",
    documentParsing: "Document parsing", imageOcr: "Image OCR", audioTranscription: "Audio transcription", localReady: "Ready locally", automaticDetection: "Auto detect", enabled: "Enabled", disabled: "Disabled", enableInWorkbench: "Enable in workbench", capabilities: "Local capabilities",
    ...
    capabilityCenter: "Local capabilities", capabilityCenterIntro: "Check whether the document conversion service is working normally.", allLocalServicesReady: "The local conversion service is ready. Return to the workbench to continue.", checkingSystemDetail: "Checking the local conversion service and task store.",
