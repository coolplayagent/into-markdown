...
const messages = {
  "zh-CN": {
    ...
    pasteFiles: "粘贴图片或文件",
    localImportHint: "支持粘贴图片或复制的文件；本机导入副本后依次转换。",
    browserImportHint: "通过浏览器选择文件或粘贴图片，导入后依次转换。",
    storageFailure: "任务存储检查失败，请重启本地服务后重试。",
    importBusy: "正在接收其他文件，请稍后重试。",
    importFailure: "文件导入未完成，请重试或重新选择文件。",
    localUnavailable: "本地选择或剪贴板不可用，请使用浏览器选择文件。",
    localBusy: "请先完成当前文件选择，再重试。",
    clipboardEmpty: "剪贴板中没有可导入的图片或文件。",
    sourceChanged: "原文件已变化或选择已过期，请重新选择文件。",
    ...
    diagnosticsPreviewUnavailable: "诊断预览不可用，请在详情与资源中下载完整诊断。", archiveExtractionRequired: "RAR 归档请先解压后再转换", unsupportedFormatFailure: "未识别出受支持的文件格式，请检查文件类型", malformedInputFailure: "文件内容损坏或格式不正确", encryptedInputFailure: "文件已加密或受密码保护", resourceLimitFailure: "文件超出当前资源限制", ocrFailure: "文字识别失败", aiFailure: "AI 处理失败", networkFailure: "网络访问失败", ioFailure: "无法读取或写入文件", componentUnavailableFailure: "所需本地依赖尚未准备", timeoutFailure: "转换超时", recoveryFailure: "无法恢复此前的转换任务", internalFailure: "转换服务遇到内部错误", conversionFailedReason: "文件内容无法转换，请检查文件是否完整", invalidOptionsFailure: "转换设置无效", serviceWaiting: "等待程序回应，将自动继续", serviceSlow: "程序回应较慢，请稍候", unreachableFailure: "无法连接本地转换服务", failureDetails: "失败详情",
  ...
  en: {
    ...
    pasteFiles: "Paste images or files",
    localImportHint: "Paste images or copied files. Local copies are converted one at a time.",
    browserImportHint: "Choose files or paste images through the browser, then convert one at a time.",
    storageFailure: "Task storage checks failed. Restart the local service before retrying.",
    importBusy: "Another file is being received. Please retry shortly.",
    importFailure: "File import did not finish. Retry or select the file again.",
    localUnavailable: "Native selection or clipboard is unavailable. Use browser file selection.",
    localBusy: "Finish the current file selection before trying again.",
    clipboardEmpty: "The clipboard has no supported images or files.",
    sourceChanged: "The source changed or the selection expired. Select the file again.",
