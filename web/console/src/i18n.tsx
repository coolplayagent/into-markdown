...
const messages = {
  "zh-CN": {
    ...
    primaryNavigation: "主要导航", history: "历史记录", conversionResult: "转换结果", currentBatch: "当前批次", close: "关闭",
  ...
  en: {
    ...
    primaryNavigation: "Primary navigation", history: "History", conversionResult: "Conversion result", currentBatch: "Current batch", close: "Close",
