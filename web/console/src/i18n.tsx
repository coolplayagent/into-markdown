...
const messages = {
  "zh-CN": {
    ...
    administration: "系统管理", administrationIntro: "查看转换能力、连接 AI 服务，并处理本机运行问题。", formats: "格式支持", models: "本地模型", providers: "AI 服务", plugins: "扩展插件", configuration: "设置", doctor: "运行诊断", verify: "验证", install: "安装", installPlugin: "安装插件", packageSource: "包来源", signerId: "签名密钥 ID", signerFingerprint: "签名密钥指纹", scope: "作用域", effective: "当前生效", shadowedBy: "被覆盖于", inherited: "继承自其他作用域", target: "目标平台", packageSha256: "包 SHA-256", timeoutMs: "超时（毫秒）", allowHosts: "允许的主机", detectFormat: "检测本地文件格式", localPath: "本地文件路径", detect: "检测", addProvider: "添加 AI 服务", providerName: "服务名称", baseUrl: "API 地址", model: "模型", environmentName: "密钥环境变量名", setDefault: "设为默认", unset: "取消设置", copyFrom: "复制自设置方案", show: "查看", enable: "启用", disable: "停用", configured: "已配置", missing: "缺失", testProvider: "测试连接", noneConfigured: "当前没有额外插件。", redactedConfiguration: "已隐藏敏感值的配置", profiles: "设置方案", save: "保存", create: "创建",
    ...
    prepareAudioTitle: "准备音频转写", installWhisperModel: "安装本地音频模型", prepareFfmpegRuntime: "准备隔离运行时", ffmpegRuntimeNote: "完整离线包随附全部组件；标准安装会下载并校验所需模型，FFmpeg 与 ONNX Runtime 必须与当前版本匹配。", copyCommand: "复制命令", done: "完成", installNow: "安装并校验", installingComponents: "正在安装…", installComponentsFailed: "组件安装失败，请检查网络或安装包后重试。",
  ...
  en: {
    ...
    prepareAudioTitle: "Prepare audio transcription", installWhisperModel: "Install local audio models", prepareFfmpegRuntime: "Prepare isolated runtimes", ffmpegRuntimeNote: "The full offline package includes every component. A standard install downloads and verifies the models; FFmpeg and ONNX Runtime must match this build.", copyCommand: "Copy command", done: "Done", installNow: "Install and verify", installingComponents: "Installing…", installComponentsFailed: "Component installation failed. Check the network or package and retry.",
