...
const DIAGNOSTIC_MESSAGES: Readonly<Record<string, MessageKey>> = {
  ...
  uploadFailed: "importFailure",
  uploadDisconnected: "importFailure",
  uploadInterrupted: "importFailure",
  uploadTimeout: "importFailure",
  localSourceUnavailable: "localUnavailable",
  localSourceBusy: "localBusy",
  localFileUnavailable: "sourceChanged",
  localRegularFileRequired: "importFailure",
  localSelectionExpired: "sourceChanged",
  localSourceChanged: "sourceChanged",
  clipboardEmpty: "clipboardEmpty",
  clipboardImageFailed: "importFailure",
